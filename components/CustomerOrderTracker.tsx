    ...
    if (variant === 'hero') {
        return (
                    ...
                    <div className="relative flex flex-col gap-6">
                        ...
                        <div className="rounded-2xl bg-black/20 p-4 sm:p-5">
                           ...
                           705	                            {promotionBanners ? (
                            ...
                            {totalDiscount > 0 ? (
                                <div className="mt-6">
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-emerald-300/30 bg-emerald-500/15 px-3 py-2 text-sm font-semibold text-emerald-100">
            ...
            <div className="mt-4 flex items-center justify-between border-t border-white/15 pt-3 text-base font-semibold text-white">
                <span>Total de la commande</span>              <span>{formatCurrencyCOP(order.total)}</span>
                            </div>
                        </div>
